...
compactdf=compactdf.drop(columns=['filename',"filename2","date","real_time","log_mean_v_mean","volume_decomposed_log_mean_gfp_min","volume_decomposed_log_mean_gfp_standard"])
